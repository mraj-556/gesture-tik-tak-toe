...
global player_turn , game_over , player_choosed , flag , i , t_g_start , t_g_res
player_turn = 1
player_choosed = 0
game_over = False
...
def set_colour(btn_name,btn_obj):
    global player_turn , game_over , player_choosed
    if not game_over:
...
flag = True
def game_result():
    global flag , i , game_over , t_g_start , t_g_res
    flag1 = True   
    while flag1:
